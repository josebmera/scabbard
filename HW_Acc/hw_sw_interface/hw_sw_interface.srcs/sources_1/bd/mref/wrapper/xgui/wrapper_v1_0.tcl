...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "REG_DATA_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.REG_DATA_WIDTH { PARAM_VALUE.REG_DATA_WIDTH } {
	# Procedure called to update REG_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.REG_DATA_WIDTH { PARAM_VALUE.REG_DATA_WIDTH } {
	# Procedure called to validate REG_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.REG_DATA_WIDTH { MODELPARAM_VALUE.REG_DATA_WIDTH PARAM_VALUE.REG_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.REG_DATA_WIDTH}] ${MODELPARAM_VALUE.REG_DATA_WIDTH}
}
